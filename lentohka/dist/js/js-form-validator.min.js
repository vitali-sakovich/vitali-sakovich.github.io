(function (q) {
    var r =
            "validate formatString destroy reload getFormHandle getFields showErrors hideErrors".split(
                " "
            ),
        m = function (a, b, c) {
            a.JsValidator = this;
    ...
    m.prototype = {
        messages: {
            en: {
                ...
                lastname: {
                    empty: "Введите название компании",
                    incorrect: "Неверное название компании",
                },
                phone: {
                ...
                minlength: {
                    empty: "Пожалуйста, введите не менее {0} символов",
        ...
        _eventChange: function (a) {
            ...
            this.validate(a.target) ||
                ...
                !this.settings.showErrors &&
                    this.submitCallback(this.errors, !1));
        },
                        ...
                        switch (c[a].handle.type) {
                                ...
                                p ||
                                    (Object.keys(n).forEach(function (a) {
                                        try {
                                            ...
                                            k =
                                                b.messages[b.settings.locale][e]
                                                    .empty;
                                        }
                                    }),
                                    (f = ""));
                            ...
                            case "file":
                                c[a].handle.files &&
                                    ...
                                    ((f = []),
                                    Object.keys(c[a].handle.files).forEach(
                                        function (b) {
                                            switch (e) {
                                                case "maxfilesize":
                                                    f.push(
            ...
            Object.keys(this.fields).forEach(function (e) {
                if ((a && a === c.fields[e].handle) || !a)
                    (d = c.fields[e].handle.nextElementSibling),
                        b &&
                            c.fields[e].handle.classList.remove(
                ...
                a
                    ? Object.keys(b.fields).forEach(function (e) {
                          b.fields[e].handle.getAttribute("name") ===
                              a.getAttribute("name") &&
                              d(b.fields[e].handle, b.errors[c]);
                      })
                    : ("0" === c ||
                          (0 < c &&
                              b.fields[c].name !== b.fields[c - 1].name)) &&
